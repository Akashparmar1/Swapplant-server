...
app.use(cors({
    origin: ['http://localhost:5173', 'https://swapplant-server.onrender.com', 'https://swapplant-client-main.vercel.app/'],
    credentials: true,
...
//DB URI
const uri = `mongodb+srv://${process.env.DB_USER_ID}:${process.env.DB_PASSWORD}@cluster0.3w3ns3p.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0`;
...
async function run() {
    try {
        ...
        await client.db("swapplnt").command({ ping: 1 });
